    ...
    components: [
      {
        ...
        type: "Preview",
        props: {
          children: "Welcome to our platform! We're excited to have you.",
        },
      },
      {
        id: "container-1",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "Thanks for signing up! We're thrilled to have you join our community. Your account is now active and ready to use.",
          style: {
            fontSize: "16px",
            lineHeight: "26px",
            color: "#555555",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "Here's what you can do next:",
          style: {
            fontSize: "16px",
            fontWeight: "600",
            color: "#333333",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "If you have any questions, just reply to this email—we're always happy to help.",
          style: {
            fontSize: "14px",
            color: "#888888",
          },
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "We received a request to reset your password. Click the button below to choose a new password.",
          style: {
            fontSize: "16px",
            lineHeight: "26px",
            color: "#555555",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "This link will expire in 1 hour. If you didn't request a password reset, you can safely ignore this email.",
          style: {
            fontSize: "14px",
            color: "#888888",
            marginTop: "24px",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "If the button doesn't work, copy and paste this link: https://example.com/reset-password?token=abc123",
          style: {
            fontSize: "12px",
            color: "#aaaaaa",
            wordBreak: "break-all",
    ...
    components: [
      {
        ...
        type: "Preview",
        props: {
          children: "Your order has been confirmed! Order #12345",
        },
      },
      {
        id: "container-1",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "Thank you for your order! We're getting it ready and will notify you when it ships.",
          style: {
            fontSize: "16px",
            lineHeight: "26px",
            color: "#555555",
      ...
      },
      {
        ...
        type: "Text",
        props: {
          children: "Premium Plan (Annual) — $99.00\nSetup Fee — $0.00\n\nSubtotal: $99.00\nTax: $8.91\n\nTotal: $107.91",
          style: {
            fontSize: "14px",
            lineHeight: "24px",
            color: "#555555",
